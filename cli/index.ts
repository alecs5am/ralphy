...
import { postizCmd } from "./commands/postiz.js";
import { publicationCmd } from "./commands/publication.js";
...
program.addCommand(publicationCmd());
program.addCommand(postizCmd());

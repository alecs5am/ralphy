...
export const ERROR_CODES = {
  ...
  E_MIGRATION_LOCKED: {
    class: "user",
    httpAnalog: 409,
    message: "Migration is locked by another process: {path}",
    hint: "Use the matching migration resume/recover command after the owner exits; never delete the lock manually.",
    relatedDocs: "docs/superpowers/plans/2026-08-02-full-library-migration-implementation.md#task-2",
  },
  E_MIGRATION_SPACE: {
    class: "user",
    httpAnalog: 507,
    message: "Insufficient safe staging space for migration: {detail}",
    hint: "Free space on the source volume and rerun the migration audit.",
    relatedDocs: "docs/superpowers/plans/2026-08-02-full-library-migration-implementation.md#task-2",
  },
  E_MIGRATION_COVERAGE: {
    class: "gate",
    httpAnalog: 422,
    message: "Migration coverage is incomplete: {detail}",
    hint: "Resolve every blocking inventory issue before freezing the migration.",
  ...
  E_MIGRATION_CUTOVER: {
    class: "gate",
    httpAnalog: 409,
    message: "Migration cutover was refused: {detail}",
    hint: "Keep the recovery root and rerun the exact cutover recovery step after the preflight issue is resolved.",
    relatedDocs: "docs/superpowers/plans/2026-08-02-full-library-migration-implementation.md#task-8",
  },
  E_JOBS_IN_FLIGHT: {
    class: "user",
    httpAnalog: 409,
  ...
  E_PROVIDER_AUTH: {
    ...
    relatedDocs: ".agents/skills/troubleshooting/SKILL.md#keys",
  },
  ...
  E_GATE_SCENARIO: {
    ...
    relatedDocs: ".agents/skills/scenarist/SKILL.md#gate",
  },
  E_GATE_IMAGE: {
    class: "gate",
    ...
    relatedDocs: ".agents/skills/art-director/SKILL.md#gate",
  },
  E_GATE_VIDEO: {
    class: "gate",

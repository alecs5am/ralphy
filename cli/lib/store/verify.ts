...
const TEXT_COLUMNS = {
  ...
  jobs: "run_id,kind,status,command,depends_on,error_message,log_path,tag,project_id,migration_hold_run_id",
  ...
  migration_sources: "id,migration_run_id,source_kind,source_label,canonical_path_hash,source_device,source_inode,inventory_digest",
...
const LOCATOR_COLUMNS = new Set([
  ...
  "migration_entries.source_path",
  "migration_entries.target_path",
]);

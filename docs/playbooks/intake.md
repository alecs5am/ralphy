...
2. **Branch:**
   ...
   - **Nothing matches** → enter **free-form mode**, jump to `docs/playbooks/scenarist.md` step "scenario-from-brief". Say once: "No template fits this one — drafting freeform from your brief." Then proceed without asking.

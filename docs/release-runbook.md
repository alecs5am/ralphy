...
[`.agents/skills/dev-release/SKILL.md`](../.agents/skills/dev-release/SKILL.md) drives the
...
version drift between channels (per `09-D-05`).
...
Don't try to amend the release. 09.04.03
...
4. If this was a milestone release (v0.2, v0.3, …) per
   `09-D-03`,
   update `roadmap/README.md` "Milestone path" section to mark

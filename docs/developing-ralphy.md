...
| `docs-mintlify/reference/nodes/*.mdx` | `bun run docs:nodes` (`scripts/build-node-docs.ts`) | After any change to the workflow-node schema / signatures / executor registry (`cli/lib/schemas/workflow.ts`, `cli/lib/workflow/executors/`) |

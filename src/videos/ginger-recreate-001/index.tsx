...
const SCENES: Scene[] = [
  ...
  { id: "02", kind: "card",  card: { word: "officially", emoji: "🤌", wordStyle: "bold" } },
  { id: "03", kind: "video", asset: vid("03") },
  { id: "04", kind: "video", asset: vid("04") },
  { id: "05", kind: "card",  card: { word: "not achieve", emoji: "💝", wordStyle: "bold" } },
  { id: "06", kind: "video", asset: vid("06") },
  { id: "07", kind: "video", asset: vid("07") },
  { id: "08", kind: "video", asset: vid("08") },
  { id: "09", kind: "card",  card: { word: "life", emoji: "🤍", wordStyle: "bold" } },
...
const WORDS: Word[] = [
  { text: "I",                    startMs: 59,    endMs: 199,   style: "bold",   size: "xl" },
  { text: "officially",           startMs: 539,   endMs: 1120,  style: "bold" },
  { text: "allow",                startMs: 1379,  endMs: 1919,  style: "italic" },
  { text: "myself",               startMs: 1979,  endMs: 2319,  style: "italic" },
  { text: "nothing",  display: "NOTH*NG", startMs: 2919, endMs: 3339, style: "bold", size: "xl" },
  { text: "in this life",         startMs: 3379,  endMs: 3959,  style: "italic", size: "m" },
  { text: "to",                   startMs: 4139,  endMs: 4239,  style: "bold" },
  { text: "achieve,",             startMs: 4279,  endMs: 4779,  style: "bold" },
  { text: "live",                 startMs: 5359,  endMs: 5799,  style: "bold" },
  { text: "an ordinary",          startMs: 5900,  endMs: 6299,  style: "bold" },
  { text: "perfectly average",    startMs: 6339,  endMs: 7539,  style: "italic", size: "m" },
  { text: "life",                 startMs: 7859,  endMs: 8179,  style: "bold" },
  { text: "and",                  startMs: 8859,  endMs: 9019,  style: "italic" },
  { text: "enjoy it,",            startMs: 9479,  endMs: 10059, style: "italic" },
  { text: "just enjoy",           startMs: 10859, endMs: 11659, style: "italic" },
  { text: "being alive",          startMs: 11719, endMs: 12479, style: "italic", size: "m" },
  { text: "That's it!",           startMs: 13179, endMs: 13559, style: "bold",   size: "xl" },
];

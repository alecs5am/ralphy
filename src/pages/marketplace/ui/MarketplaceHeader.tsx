...
export function MarketplaceHeader({
  ...
  return <header className="marketplace-header grid shrink-0 grid-cols-(--marketplace-header-columns) items-center gap-x-4 gap-y-2 rounded-panel bg-surface px-5 py-3.5 text-ink @max-marketplace-split/main-region:grid-cols-1">
    ...
    <form className="marketplace-search flex h-control-lg w-full max-w-110 min-w-0 items-center gap-2 justify-self-center rounded-control bg-surface-sunken py-0 pr-0.5 pl-3 @max-marketplace-split/main-region:max-w-none" role="search" onSubmit={submit}>

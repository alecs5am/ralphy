/**
 * Turning one workspace overview payload into what the screen draws.
 *
 * Nothing here fetches and nothing here decides layout: each `present*` reads the payload and the
 * clock, and says what is known and what is not. The shapes it returns live beside this file.
 */
import type {
  MetricTotals,
  OverviewAccountDto,
...
} from "./overview-presentation-types";

export type * from "./overview-presentation-types";

...
export const VERB_SHAPES: Record<string, VerbShape[]> = {
  ...
  farm: [
    ...
    { label: "farm.stop.dead", shape: { workspace: "my-studio", stopped: false, pid: null, detail: "no live farm process (stale pidfile cleared if present)" } },
    {
      ...
      shape: {
        workspace: "my-studio",
        store: ".ralphy/workspaces/my-studio/farm/dead-letter.jsonl",
        total: 1,
        unresolved: 1,
        failures: [
          {
            ts: "2026-07-06T09:01:00.000Z",
            run: "farm-news-20260706-090000",
            node: "gen-image",
            branch: 2,
            inputsHash: "b0a3f5e2c1d4a6b8e9f0a1b2c3d4e5f60718293a4b5c6d7e8f9a0b1c2d3e4f5a",
            errorClass: "moderation",
            filterClass: "safety-output",
            attempts: 1,
            costSpentUsd: 0.04,
            providerPayloadExcerpt: "IMAGE_SAFETY: the generated image was blocked",
            nextActionHint: "the model's safety filter blocked this prompt / input frame — rephrase or swap models",
            resolved: false,
            resolvedAt: null,
          },
        ],
    ...
    },
    {
      ...
      shape: {
        workspace: "my-studio",
        runId: "farm-news-20260706-090000",
        status: "complete",
        detail: null,
        node: "gen-image",
        invalidated: ["gen-image", "render", "publish"],
        quarantineResolved: true,
      },
    },
    {
      label: "farm.review.list",
      shape: {
        run: "farm-news-20260706-090000",
        workspace: "my-studio",
        status: "parked-approval",
        ...
        cards: [
          {
            ...
            media: {
              kind: "video",
              paths: [".ralphy/workspaces/my-studio/projects/spring-2026-001/units/hero-cut/final.mp4"],
              thumbnail: ".ralphy/workspaces/my-studio/projects/spring-2026-001/units/hero-cut/thumb.png",
            },
            caption: "One unit, four platforms.",
            title: "Hero cut",
            targets: ["youtube", "tiktok"],
            scheduleAt: "2026-07-09T15:30:00.000Z",
            scorecard: { verdict: "ship", score: 88, criteria: [] },
            costUsd: 0.42,
            status: "parked-approval",
            reason: "approval node \"publish\": no run approval is recorded yet",
          },
        ],
      },
    },
    {
      label: "farm.review.action",
      shape: {
        run: "farm-news-20260706-090000",
        workspace: "my-studio",
        node: "publish",

...
This is the file the agent reads when you ask "how much have I spent on this project?" — it's also what the [postmortem skill](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/ralphy-postmortem/SKILL.md) consumes. Treat it as immutable. See [Generation log](/concepts/generation-log) for the full schema.

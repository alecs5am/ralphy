...
Public templates live in the hosted content library (browse on [`/library`](https://www.alecs5am.com/library)); your own live under `workspace/templates/`. Categories are organized by **who's watching** the content, not by visual style. The full roster is on the Library; a quick map:

...
The phrasing on the left triggers the playbook on the right. Mix of English and Russian — both are first-class.

| You say | Ralphy reads |
|---|---|
| "Сделай видео про мой новый кофейный сироп" | [`intake.md`](https://github.com/alecs5am/ralphy/blob/main/docs/playbooks/intake.md) — five questions, draft plan, wait for "go" |
| "Make me something like this `<tiktok-url>`" | [`ralph-researcher` skill](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/ralph-researcher/SKILL.md) → pulls the URL, then intake |
...
| "Сделай 10 вариантов под этот шаблон" | [`producer.md`](https://github.com/alecs5am/ralphy/blob/main/docs/playbooks/producer.md) → `batch create-from-template` |
| "Is this render ready to ship?" | [`ralph-evaluator` skill](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/ralph-evaluator/SKILL.md) — scene-by-scene scoring |

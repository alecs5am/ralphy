...
3. **The skill or playbook picks a template.** Templates live under `templates/<category>/<slug>/` and declare a `template.yaml`. See [Template format](/advanced/template-format).
...
- [Cookbook: new template](/cookbook/new-template) — full walkthrough for shipping one.
- [Cookbook: new skill](/cookbook/new-skill) — same, for a skill.
- [Cookbook: new model](/cookbook/new-model) — same, for a `MODELS.md` entry.

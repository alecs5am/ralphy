...
The current split: scenarist, art-director, editor, producer, researcher, core are playbooks. `ralphy-evaluator`, `ralphy-researcher`, `ralphy-templater`, `ralphy-install`, `release`, `hyperframes`, `skill-creator` are skills.

...
The current split: scenarist, art-director, editor, producer, researcher, core are playbooks. `evaluator`, `researcher`, `templater`, `install`, `dev-release`, `hyperframes`, `dev-tasks` are skills.

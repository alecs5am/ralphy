...
description: "Timeline-aware composer. Reads assets/ + scenario.json + scribe captions, builds a Timeline, optionally re-flows after structural edits, and renders a single mp"
---

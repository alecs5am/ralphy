---
title: "ralphy render"
description: "Render a project to MP4. Engine: HyperFrames (HTML + GSAP). Writes workspace/projects/<id>/render/final.mp4. Adds EBU R128 loudnorm with --loudnorm. Also auto-e"
---

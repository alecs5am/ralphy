...
| [`templater`](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/templater/SKILL.md) | `user` | shipped project → vibe-reference template under `templates/<category>/<slug>/` |

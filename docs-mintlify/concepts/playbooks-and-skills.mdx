...
| [`hyperframes`](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/hyperframes/SKILL.md) | `ralphy` | HyperFrames composition question → topic-specific sub-doc |

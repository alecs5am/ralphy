...
| URL drop, "analyze @handle", "what's trending in X" | `researcher.md` (and the `/ralph-researcher` skill) |
...
| "evaluate / score / QA" a rendered mp4 | `/ralph-evaluator` skill |
...
|---|---|---|
| [`ralph-evaluator`](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/ralph-evaluator/SKILL.md) | `ralphy` | rendered mp4 → `eval.json` + `eval-report.md` |
| [`ralph-researcher`](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/ralph-researcher/SKILL.md) | `ralphy` | URLs / handles / topic → `report.md` + `sources.json` |
| [`ralph-templater`](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/ralph-templater/SKILL.md) | `ralphy` | shipped project → vibe-reference template under `templates/<category>/<slug>/` |
...
| [`release`](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/release/SKILL.md) | `ralphy-dev` | main-branch HEAD → new GitHub Release + brew + npm publication |
| [`remotion-best-practices`](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/remotion-best-practices/SKILL.md) | `ralphy-dev` | Remotion API question → topic-specific sub-doc |
| [`skill-creator`](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/skill-creator/SKILL.md) | `ralphy-dev` | "create a skill" → new SKILL.md scaffolded and lint-clean |
...
|---|---|---|
| `ralphy` | end users | `ralph-evaluator`, `ralph-researcher`, `ralph-templater`, `ralphy-install` |

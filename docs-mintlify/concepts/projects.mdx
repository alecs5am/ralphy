...
A project does not have to walk all five stages. A quick batch project ("make 10 variants of the same hook") collapses intake into one line and skips the postmortem. A research-only project (`/ralph-researcher https://tiktok.com/...`) lands under `workspace/research/<slug>/` and never becomes a video at all.

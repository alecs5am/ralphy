...
The `/ralph-researcher` skill is the human entry-point; this CLI is the contract underneath. Full surface: [`/reference/cli/research`](/reference/cli/research).
...
| Symptom | Verb |
|---|---|
| User drops one URL, wants a teardown | `ralphy research add-source` (or the `/ralph-researcher` skill) |
...
- [Evaluator skill](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/ralph-evaluator/SKILL.md) — eval triggers + invariants

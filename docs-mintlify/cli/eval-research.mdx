...
The `/researcher` skill is the human entry-point; this CLI is the contract underneath. Full surface: [`/reference/cli/research`](/reference/cli/research).
...
- [Evaluator skill](https://github.com/alecs5am/ralphy/blob/main/.agents/skills/evaluator/SKILL.md) — eval triggers + invariants

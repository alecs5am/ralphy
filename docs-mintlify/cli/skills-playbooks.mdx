...
Examples of skills shipped today: `ralphy-researcher`, `ralphy-evaluator`, `ralphy-install`, `release`, `postmortem`, `hyperframes`, `skill-creator`. Playbooks: `intake`, `researcher`, `scenarist`, `art-director`, `editor`, `producer`, `core`, `ralphy-install`, `hyperframes`, plus the per-domain references.

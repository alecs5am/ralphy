...
export const DETAIL_ROUTE = "flex min-w-0 flex-col gap-2 pt-2 pb-4";
...
export const DETAIL_HERO = "grid min-w-0 grid-cols-(--marketplace-hero-columns) gap-x-3 gap-y-2 rounded-widget bg-instrument p-3 text-on-instrument @max-marketplace-split/main-region:grid-cols-1";
export const DETAIL_EYEBROW = "col-span-full font-mono type-meta uppercase tracking-eyebrow text-on-instrument-muted";
export const DETAIL_TITLE = "m-0 min-w-0 type-title font-medium leading-row wrap-anywhere";
...
export const DETAIL_SECTION = "min-w-0 rounded-cell bg-surface p-3";
export const ASIDE_SECTION = "min-w-0 rounded-cell bg-surface-sunken p-3 text-ink";
export const DETAIL_HEADING = "m-0 mb-2 type-sm font-medium";
export const DETAIL_SUBHEADING = "m-0 mt-3 mb-2 type-sm font-medium text-ink";
...
export const LIBRARY_ROUTE = "grid min-w-0 content-start gap-2 pt-2 pb-4";
export const LIBRARY_TITLE = "m-0 type-base font-medium";
...
export const LIBRARY_UNAVAILABLE = "grid min-w-0 content-start gap-2 rounded-widget bg-surface p-3";
export const LIBRARY_PLATE = "rounded-widget bg-surface-sunken p-3";

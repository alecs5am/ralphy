...
const sharedOwners: readonly [string, readonly string[]][] = [
  ["generation.unit-save", ["workspace.generation", "workspace.canvas"]],
  ["generation.parameters", ["workspace.generation", "workspace.canvas"]],
  ["canvas.parameters", ["workspace.canvas"]],
  ["canvas.switcher", ["workspace.canvas"]],
  ["canvas.connector", ["workspace.canvas"]],
  ...
  ["marketplace.visual", ["marketplace.detail"]],
];
...
if (fixtures.size !== 435 || fixtures.size !== registrations.length) throw new Error("Invalid instrument test fixture inventory");

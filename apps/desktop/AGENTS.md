...
This package owns the Electron desktop application inside the Ralphy repository.
Use Bun and communicate with the runtime through its CLI/bridge contract.
Run the commands below from `apps/desktop`; `bun run check:desktop` at the

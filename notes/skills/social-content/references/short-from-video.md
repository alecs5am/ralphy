...
- Ideate (30 min): Generate 10-20 concepts
- Script (1 hour): Write scripts for 5-10 videos
- Batch film (2 hours): Record all talking head content
- Edit (2-3 hours): Edit and add captions
- Schedule (30 min): Queue for optimal times
...
- Hooks: Same content, different opening
- Length: 15 sec vs 30 sec vs 60 sec
- Format: Talking head vs slideshow vs demo
- Time: Morning vs afternoon vs evening

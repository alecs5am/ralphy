...
- For detailed templates: See references/sequence-templates.md [blocked]
...
- Pricing updates
- For detailed email type reference: See references/email-types.md [blocked]
...
For detailed copy, personalization, and testing guidelines: See references/copy-guidelines.md [blocked]
